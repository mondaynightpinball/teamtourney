...
// TODO Possibly factor in how teams finish in prior seasons to weight the schedule.

// General model driving a schedule is: League -> Season -> Week -> Match -> Team
...
function Scheduler(teamNames, machines, numRounds) {
  const teams = teamNames.map( name => {
    return { key: name, schedule: [] };
  });
